package com.example.zinsrechner.enhanced;
...
public class MainActivity extends Activity {
	private static final String JAHRE_GESAMMT = "jahre_gesammt";
	...
	protected void onSaveInstanceState(Bundle outState) {
		outState.putInt(JAHRE_GESAMMT, summeJahre);
		super.onSaveInstanceState(outState);
	}

	@Override
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		summeJahre = savedInstanceState.getInt(JAHRE_GESAMMT);
		jahre.setText(summeJahre + " Jahre");
