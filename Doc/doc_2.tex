...
\frame{\frametitle{Finde den Fehler!}		
	\begin{itemize}
        ...
        \item Coder innerhalb von "Blöcken" wie Klassen ({\tt{class}}), Methoden oder Kontrollstrukturen muss mit {\tt{\{\dots\}}} "eingerahmt" werden
...
\frame[allowframebreaks]{\frametitle{Ein kleiner Ausflug in die Boolsche Algebra}
\begin{itemize}
    \item Aussagenlogische Ausdürcke
...
Übung
\begin{itemize}
    \item {\tt true || false = \pause \textcolor{green}{ true}}\pause
