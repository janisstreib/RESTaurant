...
\frame{\frametitle{Beispiel: Eine Webseite "herunterladen"}
	...
	Benutzen sie dazu eine {\tt HttpURLConnection}, deren OutputStream in eine Datei geschrieben wird.\\ Öffen sie anschließend die html-Datei zur Verifikation in einem Webbrowser.\\ Tipp:\\ {\tt HttpURLConnection connection = (HttpURLConnection) new URL("http://google.com").openConnection();\\...\\connection.getInputStream()...}
}
\frame{\frametitle{Beispiel: Eine Webseite "herunterladen"}
